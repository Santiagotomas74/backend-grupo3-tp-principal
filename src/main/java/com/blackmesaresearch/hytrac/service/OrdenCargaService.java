...
public class OrdenCargaService {
  ...
  public OrdenCargaResponseDTO guardarNuevaOrdenCarga(
    ...
    CotResponseDTO cotResponse = arbaService.generarCot(
    ...
    String legajoJefe = usuarioRepository
  ...
  public void aprobarInicioViaje(
    ...
    String estadoAnterior = orden.getEstadoOrdenCarga().getNombre();
  ...
  public OrdenCargaResponseDTO cancelarOrden(
    ...
    Incidencia incidenciaPendiente = incidenciaRepository.findAll()
        .stream()
        .filter(i -> i.getOrden()
            .getNumeroRemito()
            .equals(
    ...
    EstadoOrdenCarga estadoCancelada = estadoOrdenCargaRepository
    ...
    // No se pide pero es un envio que se cancelo por algun motivo se informa al
    // operador?
    if (orden.getOperador() != null) {
      notificacionService.crearNotificacion(
    ...
    String legajoJefeCancel = usuarioRepository
        .findByRolAndLugarOperativo("JEFE_ESTACION", ordenActualizada.getEstacionDestino())
